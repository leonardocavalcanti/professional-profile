...
class ChangePasswordForm extends Component {
    ...
    save = () => {
        ...
        this.props.dispatch(changePassword(userDetails))
            .then(() => {
                this.handleClose();

                this.props.showMessage('Successfuly updated password.');
            })
    ...
    validateField(fieldName, value) {
        ...
        switch (fieldName) {
            ...
            case 'confirmPassword':
                ...
                break;
            case 'oldPassword':
                fieldValidationErrors.oldPassword = value.length > 0 ? null : ' is required';
                break;
            default:
                break;
        }
    ...
    validateForm() {
        this.setState({
            formValid: (
                ...
                this.state.formErrors.oldPassword === null
            )
        });
    }
    ...
    handleClose = () => {
        ...
        this.props.closeChangePasswordForm();
    }
                    ...
                    <DialogContent>
                        ...
                        <FormControl style={{ marginBottom: 10 }} fullWidth error={Boolean(this.state.formErrors.confirmPassword)}>
                            ...
                            <Input
                                ...
                                onKeyPress={this.handleKeyPress}
                            />
                            <FormHelperText>{this.state.formErrors.confirmPassword}</FormHelperText>
                        </FormControl>
                        <FormControl style={{ marginBottom: 10 }} fullWidth error={Boolean(this.state.formErrors.oldPassword)}>
                            ...
                            />
                            <FormHelperText>{this.state.formErrors.oldPassword}</FormHelperText>
                        </FormControl>
                    </DialogContent>
                    <DialogActions>
